...
CREATE TABLE IF NOT EXISTS user_role (
    ...
    CONSTRAINT u_user_role UNIQUE(account_id, role_type_id)
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS user_connection (
    ...
    PRIMARY KEY(_id),
    FOREIGN KEY(account_id) REFERENCES account(_id),
    FOREIGN KEY(conn_id) REFERENCES account(_id),
    CONSTRAINT u_user_conn UNIQUE (account_id, conn_id)
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS user_pick_history (
    ...
    CONSTRAINT u_user_pick_history UNIQUE(account_id, pick_id)
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS pick_follow (
    ...
    CONSTRAINT u_pick_follow UNIQUE(account_id, pick_id)
) ENGINE=InnoDB;
